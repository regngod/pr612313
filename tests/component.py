...
class TestFoodDelivery(unittest.TestCase):
    def test_get_token(self):
        ...
        username = "aaaaa"
        password = "123"
        response = requests.post("http://localhost:8080/get-token", data={"username": username, "password": password})
    ...
    def test_read_food_delivery(self):
        ...
        order_id = 123 
        response = requests.get(f"http://localhost:8080/food-delivery/{order_id}")
